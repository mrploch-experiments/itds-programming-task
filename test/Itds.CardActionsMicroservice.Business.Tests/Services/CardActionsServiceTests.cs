...
namespace Itds.CardActionsMicroservice.Business.Tests.Services;
...
public class CardActionsServiceTests
{
                                                                                                 ...
                                                                                                 params int[] expectedActionNumbers)
    {
        ...
        (await sut.GetAllowedActionsAsync(new CardDetails("", cardType, cardStatus, isPinSet), CancellationToken.None)).Should()
                                                                                                                       .BeEquivalentTo(expectedActionNumbers
                                                                                                                                       .Select(a => $"ACTION{a}")
                                                                                                                                       .ToList());
    }
}